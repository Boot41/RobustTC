...
from .views import create_job, get_jobs, get_job_detail, update_job, delete_job, apply_for_job, get_application_status, update_application, withdraw_application
...
urlpatterns = [
    ...
    path('api/applications/<int:application_id>', update_application, name='update_application'),
